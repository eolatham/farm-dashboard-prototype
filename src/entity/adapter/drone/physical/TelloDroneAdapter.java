...
public class TelloDroneAdapter implements AnimatedDroneInterface {
  ...
  public void scanFarm() throws IOException {
    ...
    for (int i = 0; i < 2; i++) {
        ...
        System.out.println("The drone travels forward " + travelVerticalDistance + " feet to the bottom of the farm");
        telloDrone.turnCCW(90);
        System.out.println("The drone turns 90 degrees counter clockwise");
    	telloDrone.flyForward(travelRightDistance);
        System.out.println("The drone travels forward " + travelRightDistance + " feet to the right");
        telloDrone.turnCCW(90);
        System.out.println("The drone turns 90 degrees counter clockwise");
    	telloDrone.flyForward(travelVerticalDistance);
        System.out.println("The drone travels forward " + travelVerticalDistance + " feet to the top of the farm");
    ...
    System.out.println("The drone travels forward " + travelLeftDistance + " feet to the left back to the origin");
  }
